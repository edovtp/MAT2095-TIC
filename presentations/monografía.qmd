...
En particular, se distinguen dos tipos de incertidumbre [@ohagan_dicing_2004]. Una de ellas la podemos denominar **incerteza ontólogica** (o aleatoria), mientras que la otra toma el nombre de **incerteza epistemológica**. Es importante recordar que la ontología es el estudio del *ser*, mientras que la epistemología es el estudio del *saber*.
...
Como vimos, en el paradigma Bayesiano asignamos probabilidades a todas las cantidades desconocidas, sean observables u no observables. Esto nos lleva a definir un modelo de probabilidad conjunto, i.e.

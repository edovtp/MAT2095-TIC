...
* Dada la intercambiabilidad de $y_1, ..., y_n$, las distribuciones condicionales completas $p(y_i|y_{-i})$ toman la misma forma que para $i = n$. Estas distribuciones son la pieza clave para realizar simulación a posteriori mediante muestreo de Gibbs.
...
\begin{ejemplo}[Urnas de Pólya]
  Para ilustrar los resultados anteriores, en la Figura 3 se presentan muestras aleatorias de tamaño 100 de un proceso de Dirichlet con medida de centralización Gamma(6, 4) y diferentes valores de $M = 1, 10, 50, 100, 1000, 10000$. \\
\end{ejemplo}
```
